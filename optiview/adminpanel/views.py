...
#         return redirect("adminpanel:add_category")  # redirect back to list
...
#     categories = Category.objects.all()  # For dropdown in template
...
#     # For subcategories: either all, or only those of the product's category
...
#     return render(request, "admin/company_edit.html", {"company": company})from django.shortcuts import render, redirect, get_object_or_404
from django.shortcuts import render, redirect, get_object_or_404
from django.contrib.auth.decorators import login_required
from django.contrib.auth import authenticate, login, logout
from django.contrib import messages
